    ...
    <div class="container">
        <div class="row">
            <table class="table table-striped table-custom">
                ...
                <tbody>
                    <?php
                        $sub=mysqli_query($conn,"SELECT name, email, subscription_id FROM `subscribers` ;");
                        while($subrow=mysqli_fetch_array($sub)){
                            ?>
                            <tr>
                                <td><?php echo $subrow['name']; ?></td>
                                <td><?php echo $subrow['email']; ?></td>
                                <td><?php echo $subrow['subscription_id']; ?></td>

                                <td><?php echo" <a href='remove_subscriberapi.php?name=$subrow[name]'><button type='button'class='btn btn-danger'>Remove</button></a>" ?> </td>
