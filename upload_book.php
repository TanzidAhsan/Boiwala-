...
<div class="overlay"></div>
    ...
    <h1 class="text-center fw-bold"><a href="test.php" class="text-decoration-none text-white">Boiwala</a></h1>
        ...
        if(isset($_POST['submit'])) {
            ...
            $query="INSERT INTO books(name,img,price,Catagory,seller_id) VALUES('$sname','$dst_db','$sprice','$scatagory','$seller_id')";
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <form action="upload_book.php" method="POST" enctype="multipart/form-data">
                    <p class="text-primary text-center mb-4">Upload your request to see if anybody is interested</p>
