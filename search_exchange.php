    ...
    <div class="col-12 col-lg-8">
      <div class="card">
        <div class="card-body">
          ...
          <hr>
          <h2 class="text-center">Confirm Final Order:</h2>
          <div class="row">
            <?php
            ...
            $sql="SELECT * FROM exchange WHERE price<$price";
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <a href="index.php?name=<?php echo $name; ?>" class="btn btn-primary">Exchange Now</a>
                </div>
              </div>
            </div>
            <?php } ?>
