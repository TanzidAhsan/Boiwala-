...
<div class="container ">
  <h2 class="text-center" style="color:white">Boiwala Quiz</h2>
   <?php echo '<h1 class="text-center blinking" style="color:white">  Welcome '.$_SESSION['name'].' take a quiz test</h1>'; ?><div class="card">
...
?>
<form action="http://localhost/boiwala/boiwala/result.php" method = "post">
	<?php 
    for($i=1;$i<3;$i++){
	...
	<a href = 'http://localhost/boiwala/boiwala/quiz/logout.php'>
